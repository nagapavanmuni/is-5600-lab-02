...
document.addEventListener('DOMContentLoaded', () => {
  // Parse the JSON content for users and stocks
    const stocksData = JSON.parse(stockContent);
    const userData = JSON.parse(userContent);
  
    // Generate the initial user list and Stocks data
    ...
    // Save button click event to update user information
    ...
    // Delete button click event to remove a user
